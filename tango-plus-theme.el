...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'tango-plus
   `(default                        ((,class (:foreground ,alum-6 :background ,white))))
   ...
   `(show-paren-match               ((,class (:background ,choc-1))))
   `(region                         ((,class (:background ,butter-1))))
   `(secondary-selection            ((,class (:background ,alum-1))))
   ...
   `(trailing-whitespace            ((,class (:underline ,red-1))))
   ;; Mode line faces
   ...
   ;; Font lock faces
   `(font-lock-builtin-face         ((,class (:foreground ,blue-3))))
   `(font-lock-comment-face         ((,class (:slant italic :foreground ,alum-4))))
   `(font-lock-constant-face        ((,class (:weight light :foreground ,blue-3))))
   `(font-lock-function-name-face   ((,class (:foreground ,blue-3))))
   `(font-lock-keyword-face         ((,class (:foreground ,red-3 :weight light))))
   `(font-lock-string-face          ((,class (:foreground ,orange-3))))
   `(font-lock-type-face            ((,class (:foreground ,blue-3))))
   `(font-lock-variable-name-face   ((,class (:foreground ,alum-6))))
   `(font-lock-doc-face             ((,class (:foreground ,alum-4))))
   ...
   `(markdown-header-face-1         ((,class (:inherit markdown-header-face
                                              :weight bold))))
   `(markdown-header-face           ((,class (:foreground ,blue-3))))
   `(markdown-inline-code-face      ((,class (:foreground ,orange-3))))
   `(markdown-list-face             ((,class (:weight bold))))
   `(markdown-blockquote-face       ((,class (:foreground ,orange-3 :slant italic))))
   `(markdown-pre-face              ((,class (:foreground ,orange-3))))
